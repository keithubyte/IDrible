...
public class ShotListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public ShotListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        super.setOnScrollListener(this);

        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ShotListView);
        final int scrollBarPanelLayoutId = a.getResourceId(R.styleable.ShotListView_scrollBarPanel, -1);
        final int scrollBarPanelInAnimation = a.getResourceId(R.styleable.ShotListView_scrollBarPanelInAnimation, R.anim.in_animation);
        final int scrollBarPanelOutAnimation = a.getResourceId(R.styleable.ShotListView_scrollBarPanelOutAnimation, R.anim.out_animation);
        a.recycle();
